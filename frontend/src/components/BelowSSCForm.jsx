        ...
        <div className="form-page-container">
            <div className="form-card">
                <div className="form-title-bar">
                    <h2 className="form-title">Student Below SSC Pass Registration</h2>
                </div>
                ...
                <form onSubmit={handleSubmit} className="registration-content">
                    ...
                    <div className="ssc-section">
                        <h3 className="section-header">SCHOOL DETAILS</h3>
                        <div className="form-grid-2x2">
                            <div className="form-group">
                                <label>School Name</label>
                                <input type="text" name="schoolName" value={formData.schoolName} onChange={handleChange} placeholder="School Name" />
                            </div>
                            <div className="form-group">
